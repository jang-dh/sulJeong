	...
	<section class="divider">
		<div class="container">
			<div class="row">
              ...
              <hr> -->
						<p>다음 사항을 작성해주세요</p>
						<form id="job_apply_form" name="job_apply_form" action="${pageContext.request.contextPath}/mypage/personalQuestionInsert"
							method="post">
							<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
							<div class="form-group">
								<label>제목 <small>*</small></label> <input name="subject" type="text" placeholder="제목을 입력하세요" required="" class="form-control">
							</div>
