...
<div class="main-content">
	...
	<section>
		<div class="container">
			<div data-example-id="hoverable-table" class="bs-example" style="width: 100%">
			...
			<a href="${pageContext.request.contextPath}/mypage/personalQuestionForm" class="btn btn-dark btn-theme-colored btn-circled pull-right mt-20">등록</a>
		</div>
