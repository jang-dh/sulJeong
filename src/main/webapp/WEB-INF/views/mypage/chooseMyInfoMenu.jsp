  ...
  <div class="tab-pane fade in active" id="home">
  	<div id="content">
		<div class="row">
          ...
          <br><br>
            <form name="reg-form" class="register-form" method="post"  action="/controller/memberJoin" onsubmit="return CheckForm(this)">
            <!-- 스프링 security 4에선 POST 전송시무조건 csrt 를 보내야 한다. (GET은 안보내도 됨)-->
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  <label>UserID</label>
                  <input name="name" id="name" class="form-control" type="text" value="${member.id}">
                </div>
              </div>
              ...
              <div class="row">
                 <div class="form-group col-md-12">
                  <label for="form_choose_username">Name</label>
                  <input id="id" name="id" class="form-control" type="text" value="${member.name}">
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  <label>휴대폰</label>
                  <input name="phone" id="phone" class="form-control" type="text" value="${member.phone}">
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  ...
                  <input id="addr" name="addr" class="form-control" type="text" value="${member.addr}"> 
                </div>
                <div class="form-group col-md-6">
                  <label>주소 찾기</label>
