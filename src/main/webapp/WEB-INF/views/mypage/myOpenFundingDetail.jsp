	...
	<div class="container pt-20 pb-20">
		...
		<div class="row">
			...
			<div class="col-md-9">
										...
										<tbody>
											<c:forEach items="${fundingReqManage}" var="fundingReqManage"
												...
												<tr>
													...
													<td><a
														href="${pageContext.request.contextPath}/mypage/myOpenFundingReqManage/${fundingReqManage.code}">${fundingReqManage.subject}</a></td>
						...
						<div class="row">
							<div class="col-md-12">
								<div data-example-id="hoverable-table" class="bs-example">
												...
												<tbody>
													<c:forEach items="${fundingOpenPeople}" var="fundingOpenPeople" varStatus="state">
														<tr>
															...
															<c:choose>
																<c:when
																	test="${fundingOpenPeople.purchase.courier==null}">
																	<td><input type="text"> <!--  courier-->
																	</td>
																	<td><input type="text">
																	<!--  deliveryNumber--> <input type="hidden"
																		value="${fundingOpenPeople.code}"> <!-- memberCode -->
																		<input type="hidden" value="${fundingCode}">
																	<!-- fundingCode --></td>
																	<td><input type="button" id="deliveryBtn"
																		class="btn btn-dark btn-sm" name="deliveryBtn"
																		value="입력"></td>
																</c:when>
																<c:otherwise>
																	<td><input type="text" id="courier2"
																		name="courier2"
																		value="${fundingOpenPeople.purchase.courier}"
																		readonly="readonly"></td>
																	<td><input type="text" id="deliveryNumber2"
																		name="deliveryNumber2"
																		value="${fundingOpenPeople.purchase.deliveryNumber}"
																		readonly="readonly"> <input type="hidden"
																		id="memberCode2" name="memberCode2"
																		value="${fundingOpenPeople.code}"> <input
																		type="hidden" id="fundingCode2" name="fundingCode2"
																		value="${fundingCode}"></td>
																	<td><input type="button"
																		class="btn btn-dark btn-sm" id="updateBtn"
																		name="updateBtn"
																		onclick="location.href='${pageContext.request.contextPath}/mypage/deliveryUpdate/${fundingCode}/${fundingOpenPeople.code}'"
																		value="수정"></td>
																</c:otherwise>
															</c:choose>
									...
									<form
										action="${pageContext.request.contextPath}/mypage/deliveryCode"
										name="userInfo" id="userInfo" method="post">
										<input type="hidden" id="courier" name="courier"> <input
											type="hidden" id="deliveryNumber" name="deliveryNumber" /> <input
											type="hidden" id="memberCode" name="memberCode"> <input
											type="hidden" id="fundingCode" name="fundingCode">
									</form>
				...
				<a href="${pageContext.request.contextPath}/mypage/myOpenFunding" class="pull-right mt-20 mb-50">목록으로 돌아가기</a>
			</div>
		</div>
	</div>
</section>