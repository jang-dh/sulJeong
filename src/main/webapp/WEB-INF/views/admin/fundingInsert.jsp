			...
			<div class="col-md-2">
				<div class="vertical-tab">
					<ul class="nav nav-tabs">
						<li>
							<a href="${pageContext.request.contextPath}/admin/siteManagement">사이트 통계</a>
						</li>
						<li class="active">
							<a href="${pageContext.request.contextPath}/admin/fundingInsert">펀딩 등록</a>
						</li>
						<li>
							<a href="${pageContext.request.contextPath}/admin/personalQuestion">1:1 문의 내역</a>
						</li>
						<li>
							<a href="${pageContext.request.contextPath}/admin/fundingRequest">펀딩 오픈 신청 내역</a>
						</li>
					</ul>
				</div>
			</div>
						...
						<section id="home" class="divider bg-lighter">
							<div class="bg-lightest border-1px p-25">
								...
								<form id="appointment_form" name="appointment_form" class="mt-30" method="post"
									action="${pageContext.request.contextPath}/admin/fundInsert?${_csrf.parameterName}=${_csrf.token}"
									enctype="multipart/form-data">
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group mb-10">
												펀딩 이름 : 
												<input id="title" name="title" class="form-control required" type="text" placeholder="펀딩 이름" aria-required="true">
											</div>
										</div>
										...
										<div class="col-sm-12">
											<div class="form-group mb-10" id="fundingListAccept">
												<c:choose>
													<c:when test="${empty funding}">
														펀딩승인 목록 : 
														<select id="mdCode" name="mdCode" class="form-control required">
													...
													<c:otherwise>
															작성자 코드 : 
															<input type="text" id="mdCode2" name="mdCode" class="form-control required" readonly="readonly" value="${funding.mdCode}">
													</c:otherwise>
												</c:choose>
											</div>
										</div>
										...
										<div class="col-sm-12">
											<div class="form-group mb-10">
												상품명 : 
												<input id="rewardName" name="rewardName" class="form-control required" type="text" required="" placeholder="상품명" aria-required="true">
											</div>
										</div>
										<div class="col-sm-12">
											<div class="form-group mb-10">
												상품가격 : 
												<input id="rewardPrice" name="rewardPrice" class="form-control required" type="text" required="" placeholder="상품가격" aria-required="true">
											</div>
										</div>
										<div class="col-sm-12">
											<div class="form-group mb-10">
												목표금액 : 
												<input id="goalPrice" name="goalPrice" class="form-control required" type="text" required="" placeholder="목표금액" aria-required="true">
											</div>
										</div>
										<div class="col-sm-12">
											<div class="form-group mb-10">
												<c:choose>
													<c:when test="${!empty funding}">
														시작일 : 
														<input id="openDate2" name="openDate" class="form-control required date-picker" type="text" required="" placeholder="시작일" aria-required="true">
													</c:when>
													<c:otherwise>
														시작일 : 
														<input id="openDate" name="openDate" class="form-control required date-picker" type="text" required="" placeholder="시작일" aria-required="true">
													</c:otherwise>
												</c:choose>
											</div>
										</div>
										<div class="col-sm-12">
											<div class="form-group mb-10">
												<c:choose>
													<c:when test="${!empty funding}">
														마감일 : 
														<input id="endDate2" name="endDate" class="form-control required date-picker" type="text" required="" placeholder="마감일" aria-required="true">
													</c:when>
													<c:otherwise>
														마감일 : 
														<input id="endDate" name="endDate" class="form-control required date-picker" type="text" required="" placeholder="마감일" aria-required="true">
													</c:otherwise>
												</c:choose>
											</div>
										</div>
