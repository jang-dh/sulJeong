									...
									.ajax(
											{
												...
												data : allDate,
												success : function(result) {
													var str = "오늘 사이트를 방문한 사람 수 : "
															+ result.visit
															+ "명";
													var str2 = "오늘 등록한 펀딩 수 : "
															+ result.fundingApply
															+ "개";
													var str3 = "오늘 사람들이 결제한 총 금액 : "
															+ AddComma(result.purchasePrice)
															+ "원";
													var str4 = "오늘 사람들이 펀딩에 참여한 수 : "
															+ result.purchaseCount
															+ "번";
													var str5 = "오늘 사람들이 결제 취소한 금액 : "
															+ AddComma(result.cancelPrice)
															+ "원";
													$("#display").html(str);
													$("#display2").html(str2);
													$("#display3").html(str3);
			...
			<div class="col-md-2">
				<div class="vertical-tab">
					<ul class="nav nav-tabs">
						<li class="active"><a
							href="${pageContext.request.contextPath}/admin/siteManagement">사이트
								통계</a></li>
						<li><a
							href="${pageContext.request.contextPath}/admin/fundingInsert">펀딩
								등록</a></li>
						<li><a
							href="${pageContext.request.contextPath}/admin/personalQuestion">1:1
								문의 내역</a></li>
						<li><a
							href="${pageContext.request.contextPath}/admin/fundingRequest">펀딩
								오픈 신청 내역</a></li>
					</ul>
				</div>
			</div>
	...
	$(document).ready(
			function() {
				...
				window.onload = function() {
					var chart_lineChart = document.getElementById("lineChart")
							.getContext("2d");
					window.myLine = new Chart(chart_lineChart).Line(
							lineChartData, {
								responsive : true
							});

					var chart_barChart = document.getElementById("barChart")
							.getContext("2d");
					...
					var chart_lineChart2 = document
							.getElementById("lineChart2").getContext("2d");
					window.myLine = new Chart(chart_lineChart2).Line(
							lineChartData2, {
								responsive : true
							});

					var chart_barChart2 = document.getElementById("barChart2")
							.getContext("2d");
					window.myBar = new Chart(chart_barChart2).Bar(
							barChartData2, {
								responsive : true
							});

					var chart_lineChart3 = document
							.getElementById("lineChart3").getContext("2d");
					window.myLine = new Chart(chart_lineChart3).Line(
							lineChartData3, {
								responsive : true
							});
