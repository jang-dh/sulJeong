...
<script type="text/javascript"
	src="//dapi.kakao.com/v2/maps/sdk.js?appkey=c4c64b0fa5dfd1841cf29f48be1a0d91&libraries=services"></script>
...
<div class="main-content">
	...
	<!-- Divider: Mission -->
	<section class="divider parallax layer-overlay overlay-deep" data-bg-img="${pageContext.request.contextPath}/resources/images/introduce/bg_img.png">
		<div class="container pt-40 pb-60">
			<div class="row text-justify">
				<div class="col-md-6">
					<h3 class="line-bottom">리워드 펀딩이란?</h3>
					<p>리워드형 펀딩은 자금이 필요한 메이커가 펀딩을 통해 자금을 모집하여 제작하며 리워드가 완성되면 펀딩에 참여한
						서포터에게 제공하는 방식입니다. 메이커는 프로젝트 진행중 서포터에게 받은 피드백을 보상품 제작에 반영하거나 프로젝트
						홍보에 도움을 준 서포터들을 위해 이벤트를 진행하는 등 펀딩하는 서포터와 제품/서비스를 만드는 메이커간의 긴밀한 소통이
						이루어지는 점이 특징입니다.</p>
				</div>
				<div class="col-md-6">
					<h3 class="line-bottom">전통주란?</h3>
					<p>전통주는 우리술, 한주(韓酒), 한국술 등으로 불릴 수 있는 우리 고유의 식문화입니다. 우리는 삼국, 고려,
						조선시대부터 다양한 종류의 전통술을 빚어왔고, ‘밥 대신 먹는다’고 할 정도로 한국인에게는 아주 뜻깊은 주류입니다.
						지금 우리나라에는 2,000종이 넘는 전통주가 유통되고 있습니다. 하지만 수많은 종류에도 불구하고 전통주는 아직
						우리에게 친숙하지 않은 것이 현실입니다. 술에 대한 이해가 부족하면 선뜻 접근하기 힘든 우리술, 그렇다 해서 모르고
						놓치기엔 너무나도 맛있고, 의미 있는 술입니다. 우리나라 전통주, 이젠 술:정(井)과 함께 알아가봐요!</p>
				</div>
	...
	<section>
		<div class="container pb-70">
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<h2 class="text-uppercase line-bottom-center mt-0">
							전통주 <span class="text-theme-colored">Gallery</span>
						</h2>
			...
			<div class="section-content">
				<div class="row">
					<div class="col-md-12">
						<div class="gallery-isotope grid-4 gutter-small clearfix"
										...
										<div class="icons-holder">
											<div class="icons-holder-inner">
												<div class="styled-icons icon-sm icon-dark icon-circled icon-theme-colored">
													<a href="${pageContext.request.contextPath}/resources/images/introduce/liquor${(i%4)+1}.jpg" data-lightbox-gallery="gallery">
